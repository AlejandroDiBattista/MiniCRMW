...
function SheetContent({
  ...
  panelSize?: "compact" | "sm" | "md" | "lg" | "full"
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          panelSize === "compact" && "data-[side=left]:sm:max-w-[300px] data-[side=right]:sm:max-w-[300px]",
          panelSize === "sm" && "data-[side=left]:sm:max-w-sm data-[side=right]:sm:max-w-sm",
          panelSize === "md" && "data-[side=left]:sm:max-w-[520px] data-[side=right]:sm:max-w-[520px]",
          panelSize === "lg" && "data-[side=left]:sm:max-w-2xl data-[side=right]:sm:max-w-2xl",
          panelSize === "full" && "data-[side=left]:sm:max-w-none data-[side=right]:sm:max-w-none",
          className
        )}
        {...props}
      >
